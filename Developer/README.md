...
└── [ModUpdateBlacklist.json5](./ModUpdateBlacklist.json5) : 模组更新黑名单
...
```bash
python Convert.py --root "D:/.minecraft/versions/CMC-Alpha" --targets kubejs config --output integrity.json
```
